...
use json.loads() or ast.literal_eval() for parsing strings safely
```
...
**Issue:** The code relies on global variables which can lead to side effects and harder testing.
